...
function nameCheck() {
   ...
   if (name == "" || name == null || name === " " || name === "  " || name === "   ") {
...
$("#submit-form").submit((e) => {
   ...
   if (check) {
      e.preventDefault();
      $.ajax({
         url: "https://script.google.com/macros/s/AKfycbxIkmDU7PpNiiz2RWdTO7EAGhKUgDjgb3ySf6umuD9E6sX1Hbsmu7ZWXB0wfrN-hhGVkw/exec",
